...
<div class="row rocket" style="padding-top: 140px">
    <div class="col-xs-12">
        <div class="container-fluid container-1">
            <form class="form-container form-container-1" action="php/phpsupprList.php" method="post">
                <div class="container-fluid container-9 text-xs-center">
                    <div style="padding-bottom: 15px"> Voulez-vous supprimer <?php echo $nom ?> ?</div>
                    <input hidden type="text" name="id" value="<?php echo $id?>">
                    <input class="btn btn-light" type="submit" value="Oui">
                    <input class="btn btn-light" type="button" value="Non" onclick="window.history.back()">
                </div>
            </form>
        </div>
    </div>
